...
public class MPGame implements Screen, ClientListener {
	...
	public void messageReceived(String message, InetAddress address) {
		...
		if (command.equals("ADDPLAYER")) {
			...
			final int multiplayerID = Integer.parseInt(arguments[1]);
		...
		if (command.equals("ADDPROJECTILE")) {
			final int playerID = Integer.parseInt(arguments[0]);
			final int projectileID = Integer.parseInt(arguments[1]);
			final String projectileType = arguments[2];
